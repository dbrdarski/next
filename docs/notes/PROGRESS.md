...
| **Grounding v1** (program termination judgment) | **v0.5 patch 0.5.1** | 🟡 | **design-closed** (compendium 1.0.18); GR-01…30, Phase GR; **wired** at executable and declared-domain seats under Principle 9. Live: numeric and linear-measure descent, lexicographic/structural descent, constant ProgressRange mutual cycles, numeric drift-away, direct-self exact tuple chains, and GR-11 required-dependency closed-orbit refutation. Owed precision includes point-base/Ackermann, peel-k/restrict-len, variable/multi-parameter ProgressRange composition, mutual/body-constant exact-chain extensions, GR-20, §8 WorldDecided, and §16 discharge. One measured Phase-GR coverage row remains ignored. |
